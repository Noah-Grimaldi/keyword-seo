...
layout = [[sg.Text('\nEnter 2-3 keywords about your article topic:\n')],
          [sg.Input(key='-INPUT2-', background_color='white')], [sg.Button('SUBMIT')], [sg.Text('\nResults:')],
          [sg.Text('(Choose 1 keyword phrase from each category)')], [sg.Button('More LONG-TAIL', key='-MORE2-', visible=False, tooltip='Place these in a <title> tag\nIn the first 100 words\nIn an image alt text\nIn an <h1> tag\nIn an <h2> or <h3> tag\nIn the last 100 words of your page!')],
          [sg.Text('Sorry, you used all 25 searches', visible=False, text_color='red', key='-TEXT1-')],
          [sg.Multiline('', size=(60, 12), disabled=True, key='-RESULTS-', text_color='orange')]]

window = sg.Window('AutomaticSEO', layout,
                   ...
                   size=(600, 450), element_justification='c')
...
while True:
    ...
    if event == 'SUBMIT':
        ...
        for i in ascii_lowercase:
            ...
            window['-RESULTS-'].update(top, append=True)
